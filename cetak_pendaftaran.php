...
<div class="container mt-5">
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            <!-- Tabel Status Verifikasi dan Pembayaran -->
            <table class="table table-bordered text-center">
                <thead>
                    <tr>
                        <th>Status Verifikasi</th>
                        <th>Status Pembayaran Pendaftaran</th>
                        <th>Status Pembayaran Daftar Ulang</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td><?php echo $status_verifikasi; ?></td>
                        <td><?php echo $status_pembayaran_pendaftaran; ?></td>
                        <td><?php echo $status_pembayaran_daftar_ulang; ?></td>
                    </tr>
                </tbody>
            </table>
